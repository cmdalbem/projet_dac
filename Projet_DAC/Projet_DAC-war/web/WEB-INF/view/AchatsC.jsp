...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Catalogue achats Cycles</title>
        ...
        <meta name="description" content="Catalogue achats cycles">
    </head>
        ...
        <div class="page">
                ...
                <div class="boitemenu">
                    ...
                    <div class='menu'>
                        <ul class='nav nav-pills'>
                            <li class="active"> <a href='AchatsC'>Achats en ligne</a> </li>
            ...
            <div class="contenu">
                <div class="espace">
                    ...
                    <div class="glisse">
                        <a class="espace" href="AchatsG"> Espace glisse</a>
                    </div>
                </div>
