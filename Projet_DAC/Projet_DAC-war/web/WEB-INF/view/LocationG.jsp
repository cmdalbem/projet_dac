...
<head>
	<meta charset="utf-8">
	<title>Catalogue location Glisse</title>
	...
	<meta name="description" content="Catalogue location glisse">
</head>
...
<body>
	<div class="page">
			...
			<div class="boitemenu">
				...
				<div class='menu'>
					<ul class='nav nav-pills'>
						...
						<li class="active"> <a href='LocationG'>Location</a></li>
		...
		<div class="contenu">
			<div class="espace">
				<div class="cycles">
					<a class="espace" href="AchatsC"> Espace cycles</a>
				</div>
				<div class="glisse">
			...
			<div class="catalogue">
				<div class="selection">
					<div class="list-group">
						<a href"#" class="list-group-item">Ski</a>
						<a href"#" class="list-group-item">Snowboard</a>
