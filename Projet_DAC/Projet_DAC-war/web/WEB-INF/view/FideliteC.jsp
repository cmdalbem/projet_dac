...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" title="style1" type="text/css" href="css/FideliteC.css" >
        ...
        <div class="page">
                ...
                <div class="boitemenu">
                    ...
                    <div class='menu'>
                        <ul class='nav nav-pills'>
                            ...
                            <li class="active"> <a href='FideliteC'>Carte de fidélité</a> </li>
                            <li> <a href='SAVC'>SAV</a> </li>
                            <li> <a href='SerivesC'>Services</a> </li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="contenu">
                <div class="espace">
                    ...
                    <div class="glisse">
                        <a class="espace" href="FideliteG"> Espace glisse</a>
                    </div>
                </div>
